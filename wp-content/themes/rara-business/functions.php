...
if ( ! defined( 'RARA_BUSINESS_THEME_VERSION' ) && ! defined( 'RARA_BUSINESS_THEME_NAME' ) && ! defined( 'RARA_BUSINESS_THEME_TEXTDOMAIN' ) ) {
	$theme_data = wp_get_theme();	
	define( 'RARA_BUSINESS_THEME_VERSION', $theme_data->get( 'Version' ) );
    define( 'RARA_BUSINESS_THEME_NAME', $theme_data->get( 'Name' ) );
    define( 'RARA_BUSINESS_THEME_TEXTDOMAIN', $theme_data->get( 'TextDomain' ) );
}
