      ...
      <div class="container">
        <?php if( get_theme_mod('it_company_page_title') != ''){ ?>
          <div class="text-center">
            <h3><?php echo esc_html(get_theme_mod('it_company_page_title','')); ?></h3>
          </div>
        <?php }?>
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4">
            <?php
            $postData1 =  get_theme_mod('it_company_about_setting');
            if($postData1){
              $args = array( 'name' => esc_html($postData1 ,'it-company'));
              $query = new WP_Query( $args );
              if ( $query->have_posts() ) :
